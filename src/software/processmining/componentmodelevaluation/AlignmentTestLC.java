...
public class AlignmentTestLC {
	...
	public static void test(String[] args) throws Exception {
		...
		String netPath;
		if (TEST) {
			logPath = "C:\\Users\\lcheng\\Desktop\\decomp\\prAm6.xes.gz";
			netPath = "C:\\Users\\lcheng\\Desktop\\decomp\\prAm6.pnml";
		} else {
			logPath = args[0];
			netPath = args[1];
		}

		net = constructNet(netPath);
		...
		for (ASynchronousMoveSorting sort : new ASynchronousMoveSorting[] { ASynchronousMoveSorting.NONE,
			...
			/*
			 * long mid2 = System.currentTimeMillis(); int cost2 =
			 * AlignmentTest.computeCost(costMOS, costMOT, initialMarking,
			 * finalMarkings, new TestPluginContext(), net, log, mapping, false,
			 * sort); long end = System.currentTimeMillis();
			 * 
			 * System.out.println("   No ILP   cost: " + cost2 + "  t: " + (end
			 * - mid2)); if (cost1 != cost2) { System.err.println("ERROR"); }
			 */
			System.gc();
			System.out.flush();
			iteration++;
