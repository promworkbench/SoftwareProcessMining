...
public class SAXParseXML extends DefaultHandler{
	...
	private HashSet<SingletonCandidate> singletons;
	private SingletonCandidate singleton;
	...
	public HashSet<SingletonCandidate> getSingletons()
	{
		return singletons;
	}
...
//	}
    ...
    public void startElement(String uri, String localName, String qName,  
        ...
        if(qName.equals("pattern"))
        {
        	...
        	else if(attributes.getValue(0).toString().equals("Singleton"))
        	{
        		singletons = new HashSet<SingletonCandidate>();
        		this.instanceType="Singleton";
        	}
        ...
        else if(qName.equals("instance"))
        {
        	...
        	else if (this.instanceType.equals("Singleton"))
        	{
        		singleton= new SingletonCandidate();
        	}
        ...
        else if (qName.equals("role")) 
        {
        	...
        	else if(this.instanceType.equals("Singleton"))// if the current pattern is singleton pattern
        	{
        		if(attributes.getValue(0).equals("Singleton"))
        		{
        			this.singleton.setSingleton(attributes.getValue(1));
        		}
//        		else if(attributes.getValue(0).equals("uniqueInstance"))
//        		{
//        			this.singleton.setUniqueInstance(attributes.getValue(1));
//        		}
        	}
        	else if (this.instanceType.equals("Command"))
        	{
	 ...
	 @Override  
	    public void endElement(String uri, String localName, String qName)  
		 	...
		 	if(qName.equals("pattern"))
	        {
		 	...
		 	else if(qName.equals("instance") && this.instanceType.equals("Singleton"))
		 	{
