...
public class ConstructRole2Values {
	...
	public static HashMap<String , ArrayList<Object>> SingletonPattern(PatternClass sp)
	{
		HashMap<String, ArrayList<Object>> role2values = new HashMap<>();
		
		role2values.put("Singleton", new ArrayList<Object>());
		if(((SingletonPatternClass)sp).getSingletonClass()!=null){
			role2values.get("Singleton").add(((SingletonPatternClass)sp).getSingletonClass());
		}
		
		role2values.put("getInstance", new ArrayList<Object>());
		if(((SingletonPatternClass)sp).getGetInstanceMethod()!=null){
			role2values.get("factoryMethod").add(((SingletonPatternClass)sp).getGetInstanceMethod());
		}
