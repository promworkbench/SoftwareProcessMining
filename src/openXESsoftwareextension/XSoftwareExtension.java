package openXESsoftwareextension;
...
public class XSoftwareExtension extends XExtension{
	...
	/**
	 * Key for the method return value set.
	 */
	public static final String KEY_RETURNVALUE = "software:returnvalue";
	...
	/**
	 * method return value prototype
	 */
	public static XAttributeLiteral ATTR_RETURNVALUE;
	...
	private XSoftwareExtension() {
		...
		ATTR_RETURNVALUE = factory.createAttributeLiteral(KEY_RETURNVALUE, "__INVALID__", this); 
		...
		this.eventAttributes.add((XAttribute) ATTR_RETURNVALUE.clone()); 
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_RETURNVALUE, "return value");
	}
...
//		}
	 ...
	 * @param returnV
	 */
	public void assignReturnValue(XEvent event, String returnV) {
		if (returnV!=null)
		{
			XAttributeLiteral attr = (XAttributeLiteral) ATTR_RETURNVALUE.clone();
			attr.setValue(returnV);
			event.getAttributes().put(KEY_RETURNVALUE, attr);
		}
	}
	
	/**
	 * extract the return value from the event. 
	 * @param event
	 * @return
	 */
	public String extractReturnValue(XEvent event)
	{
		XAttribute attribute = event.getAttributes().get(KEY_RETURNVALUE);
		if (attribute == null) {
			return null;
		} else {
			return ((XAttributeLiteral) attribute).getValue();
