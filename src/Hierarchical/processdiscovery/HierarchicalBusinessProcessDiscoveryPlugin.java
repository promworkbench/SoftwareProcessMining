...
public class HierarchicalBusinessProcessDiscoveryPlugin {
	...
	public HierarchicalPetriNet HierarchicalBehaviorDiscovery(UIPluginContext context, XLog lifecycleLog) throws ConnectionCannotBeObtained, UserCancelledException 
	{
